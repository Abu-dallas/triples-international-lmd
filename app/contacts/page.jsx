  ...
  return (
    <div className="bg-black">
      ...
      <div className="w-full pt-20 px-2">
        <p className="text-2xl text-indigo-500 font-bold mb-3 px-2">
          Contact Us through
        </p>
        <p className="text-slate-200 px-2 lg:w-[60%]">
          Our dedicated support center help to facilitate communication with our
          customers, if you need any help or question feel free to communicate
          with us through the following ways. we are available to help 24/7.
        </p>
        <div className="w-full relative h-[400px] mt-20">
          ...
          />
          <div className="absolute top-0 rounded-md px-4 w-full h-full bg-black/80 flex flex-col justify-center">
      ...
      <div className="w-full h-[500px] md:h-[600px] px-1">
        <iframe
